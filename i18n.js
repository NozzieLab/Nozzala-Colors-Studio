(function(root,factory){
  ...
  const phrases={
  "音乐律动": "Music lights",
  "让声音变成灯光。": "Turn sound into light.",
  "麦克风音乐律动": "Microphone music lights",
  "六个灯位随麦克风声音变化": "Six lights respond to microphone audio",
  "麦克风未开启": "Microphone off",
  ...
  "开启麦克风": "Start microphone",
  "停止律动": "Stop music lights",
  "SW1 到 SW6 依次响应低音到高音。": "SW1 through SW6 respond from bass to treble.",
  "六个灯一起随声音明暗变化。": "All six lights pulse with the sound.",
  "网页预览 · 连接键盘可同步灯光": "On-screen preview · Connect a keyboard to sync lights",
  "已连接键盘 · 灯光同步": "Keyboard connected · Lights synced",
  "声音只在当前浏览器分析，不录音、不上传。停止或离开此页会关闭麦克风。": "Audio is analysed only in this browser. Nothing is recorded or uploaded. Stopping or leaving this page turns off the microphone.",
  "使用系统默认麦克风。律动时请关闭 ChatGPT App，避免灯光被覆盖；结束后可重新打开。": "Uses your system’s default microphone. Close ChatGPT App so it does not override the lights; reopen it when finished.",
  "来源与说明": "Sources and notes",
  "点击开启麦克风，即可开始。": "Click Start microphone to begin.",
  "正在把声音变成灯光。": "The lights are responding to sound.",
  "未获得麦克风权限，请在地址栏允许使用麦克风后重试。": "Microphone permission was not granted. Allow it in the address bar, then try again.",
  "没有找到可用的麦克风。": "No microphone was found.",
  "麦克风不可用，可能被其他应用占用。": "The microphone is unavailable. Another app may be using it.",
  "无法开启麦克风，请重试。": "The microphone could not start. Please try again.",
  "当前浏览器无法使用麦克风，请在 HTTPS 页面或 localhost 打开。": "Microphone access is unavailable. Open this page over HTTPS or on localhost in a supported browser.",
  "音频分析无法启动，请重试。": "Audio analysis could not start. Please try again.",
  "麦克风输入已中断，请重新开始。": "Microphone input was interrupted. Please start again.",
  "键盘已断开，麦克风已关闭。": "Keyboard disconnected. The microphone is off.",
  "麦克风已关闭，灯光已熄灭。": "Microphone off. Keyboard lights are off.",
  "麦克风已关闭。": "Microphone off.",
  "无效灯光亮度": "Invalid light brightness",
  "左列": "Left column",
  "中列": "Middle column",
  "右列": "Right column",
